        ...
        {!isAdmin() && (
          <div className="mb-4 sm:mb-6 p-3 sm:p-4 bg-blue-50 border border-blue-200 rounded-xl">
            <div className="flex items-start gap-2 sm:gap-3">
              <AlertCircle
                size={18}
                className="text-blue-600 flex-shrink-0 mt-0.5 sm:mt-0"
              />
              <div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900 flex items-center gap-2 sm:gap-3">
                ...
                <span className="truncate">Advertisement Enquiries</span>
              </h1>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white border-2 border-gray-300 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all duration-200 text-xs sm:text-sm font-semibold disabled:opacity-50 shadow-sm hover:shadow-md"
              >
                <RefreshCw
                  size={16}
              ...
              <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 text-xs sm:text-sm font-semibold shadow-lg hover:shadow-xl"
              >
                <Download size={16} />
                <span>Export</span>
              </button>
        ...
        <div className="bg-white border-x border-gray-200 p-4 sm:p-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <StatCard
              ...
              color="blue"
              icon={<FileSpreadsheet size={20} className="sm:w-6 sm:h-6" />}
            />
            <StatCard
        ...
        <div className="bg-white border-x border-gray-200 p-4 sm:p-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-11 sm:h-12 border-2 border-gray-300 rounded-xl pl-10 sm:pl-12 pr-10 sm:pr-12 text-xs sm:text-sm focus:ring-2 focus:ring-blue-200 focus:border-blue-500 outline-none transition-all duration-200 hover:border-gray-400"
            />
            {searchTerm && (
              <button
        ...
        <div className="bg-white rounded-b-xl shadow-sm overflow-hidden border border-gray-200">
          {isLoading ? (
            <div className="flex flex-col items-center justify-center py-12 sm:py-16">
              <div className="animate-spin rounded-full h-12 w-12 sm:h-16 sm:w-16 border-b-4 border-blue-600 mb-3 sm:mb-4"></div>
            ...
            <div className="text-center py-12 sm:py-16 px-4">
              ...
              {searchTerm && (
                <button
                  onClick={() => setSearchTerm("")}
                  className="px-4 sm:px-6 py-2 sm:py-2.5 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-colors text-sm font-medium"
                >
                  Clear Search
                </button>
              )}
                ...
                <table className="w-full">
                  <thead className="bg-gradient-to-r from-gray-50 to-gray-100 border-b-2 border-gray-200">
                    <tr>
                      ...
                      <th className="px-4 lg:px-6 py-3 lg:py-4 text-center text-xs font-bold text-gray-700 uppercase tracking-wider">
                        Documents
                      </th>
                      <th className="px-4 lg:px-6 py-3 lg:py-4 text-center text-xs font-bold text-gray-700 uppercase tracking-wider">
                        Imported Date
                      ...
                      >
                        <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap">
                          <div className="flex items-center gap-2 lg:gap-3">
                            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center text-white font-bold text-xs lg:text-sm shadow-md flex-shrink-0">
                        ...
                        <td className="px-4 lg:px-6 py-3 lg:py-4 whitespace-nowrap">
                          <div className="flex justify-center gap-2">
                            {enquiry.aadharNo ? (
                              <span className="px-2 lg:px-3 py-1 lg:py-1.5 bg-purple-100 text-purple-700 rounded-lg text-xs font-semibold shadow-sm">
                                Aadhar
                              </span>
                            ) : (
                              <span className="px-2 lg:px-3 py-1 lg:py-1.5 bg-gray-100 text-gray-400 rounded-lg text-xs font-medium">
                                No Aadhar
                              </span>
                            )}
                            {enquiry.panNo ? (
                              <span className="px-2 lg:px-3 py-1 lg:py-1.5 bg-orange-100 text-orange-700 rounded-lg text-xs font-semibold shadow-sm">
                                PAN
                              </span>
                            ) : (
                              <span className="px-2 lg:px-3 py-1 lg:py-1.5 bg-gray-100 text-gray-400 rounded-lg text-xs font-medium">
              ...
              <div className="md:hidden divide-y divide-gray-200">
                {filteredEnquiries.map((enquiry) => (
                  <div
                    key={enquiry.id}
                    onClick={() => handleRowClick(enquiry)}
                    className="p-4 hover:bg-blue-50 cursor-pointer transition-all duration-200 active:bg-blue-100"
                  >
                    <div className="flex items-start gap-3 mb-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center text-white font-bold text-base shadow-lg flex-shrink-0">
                        {enquiry.name.charAt(0).toUpperCase()}
                      </div>
...
const StatCard: React.FC<{
  ...
  return (
    <div
      className={`bg-white rounded-xl shadow-md p-3 sm:p-4 lg:p-5 border-l-4 ${
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex-1 min-w-0">
          <p className="text-[10px] sm:text-xs text-gray-600 font-medium mb-1 truncate">
            {title}
          </p>
        ...
        <div
          className={`p-2 sm:p-3 lg:p-4 rounded-xl bg-gradient-to-br ${colorClasses[
            color as keyof typeof colorClasses
          ]
            ?.split(" ")
            .slice(1, 3)
            .join(" ")} shadow-lg flex-shrink-0`}
        >
...
const DetailsModal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/60 backdrop-blur-sm animate-fade-in">
      <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full animate-scale-in max-h-[95vh] sm:max-h-[90vh] overflow-hidden flex flex-col">
        <div className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-4 sm:px-6 py-4 sm:py-5 flex justify-between items-center flex-shrink-0">
          <div className="min-w-0 flex-1 mr-2">
            <h2 className="text-lg sm:text-2xl font-bold flex items-center gap-2">
              <FileSpreadsheet size={22} className="sm:w-7 sm:h-7 flex-shrink-0" />
              <span className="truncate">{isEditing ? "Edit Enquiry" : "Enquiry Details"}</span>
            </h2>
          ...
          <button
            onClick={onClose}
            className="p-1.5 sm:p-2 hover:bg-white/20 rounded-xl transition-all duration-200 hover:rotate-90 flex-shrink-0"
          >
        ...
        <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 overflow-y-auto flex-1">
          ...
          <div className="space-y-3 sm:space-y-4 bg-gray-50 p-3 sm:p-5 rounded-xl border border-gray-200">
            <h3 className="font-bold text-gray-800 flex items-center gap-2 border-b border-gray-300 pb-2 sm:pb-3 text-base sm:text-lg">
              <UserIcon size={18} className="sm:w-5 sm:h-5 text-blue-600 flex-shrink-0" />
              <span>Personal Information</span>
            </h3>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              <EditableField
                icon={<UserIcon size={16} className="sm:w-[18px] sm:h-[18px]" />}
                label="Full Name"
                value={enquiry.name}
                isEditing={isEditing}
          ...
          <div className="space-y-3 sm:space-y-4 bg-gray-50 p-3 sm:p-5 rounded-xl border border-gray-200">
            <h3 className="font-bold text-gray-800 flex items-center gap-2 border-b border-gray-300 pb-2 sm:pb-3 text-base sm:text-lg">
              <CreditCard size={18} className="sm:w-5 sm:h-5 text-blue-600 flex-shrink-0" />
        ...
        <div className="px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 rounded-b-2xl flex flex-col sm:flex-row justify-between gap-2 sm:gap-3 border-t border-gray-200 flex-shrink-0">
          {/* Delete button - Only for Admin */}
          {canDelete && !isEditing ? (
            <button
              onClick={onDelete}
              className="w-full sm:w-auto px-3 sm:px-4 py-2 sm:py-3 bg-red-600 text-white rounded-xl hover:bg-red-700 transition-all duration-200 text-sm font-semibold shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
            >
              <Trash2 size={16} />
          ...
          <div className="flex gap-2 sm:gap-3">
            {isEditing ? (
              <>
                <button
                  onClick={onCancel}
                  className="flex-1 sm:flex-none px-4 sm:px-6 py-2 sm:py-3 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 text-sm font-semibold transition-all duration-200"
                >
                  Cancel
                </button>
                <button
                  onClick={onSave}
                  className="flex-1 sm:flex-none px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-200 text-sm font-semibold shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <Save size={16} />
                  <span>Save</span>
                </button>
              ...
              <>
                ...
                <button
                  onClick={onEdit}
                  className="flex-1 sm:flex-none px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-200 text-sm font-semibold shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                >
                  <Edit size={16} />
                  <span>Edit</span>
                </button>
...
const EditableField: React.FC<{
  ...
  <div className={`flex items-start gap-2 sm:gap-3 ${className}`}>
    ...
    <div className="flex-1 min-w-0">
      <p className="text-[10px] sm:text-xs text-gray-500 mb-1 sm:mb-1.5 font-semibold uppercase tracking-wide">
      ...
      {isEditing ? (
        <div>
          <input
            ...
            className={`w-full px-2 sm:px-3 py-1.5 sm:py-2 border rounded-lg text-xs sm:text-sm focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all duration-200 ${
              error
    ...
    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-4 sm:p-6 animate-scale-in">
      <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
        <div className="p-2 sm:p-3 bg-red-100 rounded-full flex-shrink-0">
          <Trash2 size={22} className="sm:w-7 sm:h-7 text-red-600" />
        </div>
        <div>
      ...
      <div className="flex gap-2 sm:gap-3">
        <button
          onClick={onCancel}
          className="flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-gray-100 text-gray-700 text-sm font-semibold rounded-xl hover:bg-gray-200 transition-colors"
        >
          Cancel
        </button>
        <button
          onClick={onConfirm}
          className="flex-1 px-3 sm:px-4 py-2 sm:py-3 bg-red-600 text-white text-sm font-semibold rounded-xl hover:bg-red-700 transition-colors shadow-lg"
        >
          Delete
        </button>
      </div>
...
const Toast: React.FC<{
  ...
  return (
    <div
      className={`fixed top-4 right-4 left-4 sm:left-auto sm:right-4 z-50 flex items-center gap-2 sm:gap-3 px-4 sm:px-6 py-3 sm:py-4 rounded-xl shadow-2xl animate-slide-in ${
        type === "success"
    ...
    >
      ...
      <button
        onClick={onClose}
        className="ml-1 sm:ml-2 hover:opacity-80 transition-opacity flex-shrink-0"
      >
